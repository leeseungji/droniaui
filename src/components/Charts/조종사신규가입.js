...
const data = [
    { 날짜: '22.09.03', 조종사신규가입수: 10},
    { 날짜: '22.09.09', 조종사신규가입수: 15 },
    { 날짜: '22.09.15', 조종사신규가입수: 27 },
    { 날짜: '22.09.21', 조종사신규가입수: 20 },
    { 날짜: '22.09.27', 조종사신규가입수: 12 },
    { 날짜: '22.10.01', 조종사신규가입수: 23},
    { 날짜: '22.10.07', 조종사신규가입수: 47},
    { 날짜: '22.10.10', 조종사신규가입수: 21 },
];
    ...
    render() {
      ...
      <FormControl sx={{ m: 1, minWidth: 120 }}>
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="조종사신규가입수" stroke="#8884d8" activeDot={{ r: 8 }} />
        </LineChart>
        </FormGroup>
        </FormGroup>
        <grid>조종사신규가입페이지입니다.</grid>
        </FormGroup>
