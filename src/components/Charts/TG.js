...
const data = [
    { 날짜: '22.09.03', TaskGroup수: 10},
    { 날짜: '22.09.09', TaskGroup수: 15 },
    { 날짜: '22.09.15', TaskGroup수: 27 },
    { 날짜: '22.09.21', TaskGroup수: 20 },
    { 날짜: '22.09.27', TaskGroup수: 12 },
    { 날짜: '22.10.01', TaskGroup수: 23},
    { 날짜: '22.10.07', TaskGroup수: 47},
    { 날짜: '22.10.10', TaskGroup수: 21 },
];
    ...
    render() {
      ...
      <FormControl sx={{ m: 1, minWidth: 120 }}>
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="TaskGroup수" stroke="#8884d8" activeDot={{ r: 8 }} />
        </LineChart>
        <Grid> TaskGroup페이지입니다.</Grid>
        </FormGroup>
